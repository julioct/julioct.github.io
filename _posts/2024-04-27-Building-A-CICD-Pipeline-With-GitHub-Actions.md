...
What I did is to create a Helm chart that defines how to deploy any of my microservices to Kubernetes and then I stored it in my ACR. I won't dive into that part here, but I cover it in detail in my [microservices program]({{ site.url }}/courses/dotnetmicroservices){:target="_blank"}.
