...
If you don't have an Azure Application Insights account, check out [this article](/blog/How-To-Monitor-ASP.NET-Core-App-In-Azure) to learn how to create one and how to grab the connection string you'll need next.
...
![Alt text](/assets/images/app-insights-click-logs.png)
...
![Alt text](/assets/images/app-insights-query-logs.png)
...
![Alt text](/assets/images/app-insights-logs-filtered.png)
...
There's a lot more you can do with the .NET logging system that I didn't get to cover here, but I do cover in my [in-depth courses](courses.html), if you are interested.
