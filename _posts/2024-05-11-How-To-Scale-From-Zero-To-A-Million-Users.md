...
### **The tech**
I go into more details in my **[The .NET Developer Bootcamp]({{ site.url }}/courses/dotnetbootcamp)**, but here are some popular options in the .NET and Azure ecosystem for the different components in this architecture:
